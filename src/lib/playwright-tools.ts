...
const playwrightTools = [
    ...
    tool({
        ...
        parameters: z.object({
            ...
            promptText: z.string().nullable().describe('Text to enter into a prompt dialog.'),
        }),
        execute: async (args) => {
    ...
    tool({
        ...
        parameters: z.object({
            ref: z.string().nullable().describe('Reference to an element to pass to the function.'),
    ...
    tool({
        ...
        parameters: z.object({
            ...
            timeoutMs: z.number().nullable().describe('Timeout in ms.'),
        }),
        execute: async (args) => {
    ...
    tool({
        ...
        parameters: z.object({
            ...
            submit: z.boolean().nullable().describe('Whether to press Enter after typing.'),
            timeoutMs: z.number().nullable().describe('Timeout in ms.'),
        }),
        execute: async (args) => {
    ...
    tool({
        ...
        parameters: z.object({
            ref: z.string().nullable().describe('The ref of an element to screenshot.'),
            filename: z.string().nullable().describe('The filename to save the screenshot as.'),
            fullPage: z.boolean().nullable().describe('Whether to take a full page screenshot.'),
            raw: z.boolean().nullable().describe('Whether to return the raw image buffer.'),
        }),
        execute: async (args) => {
            const payload = {
    ...
    tool({
        ...
        parameters: z.object({
            text: z.string().nullable().describe('Text to wait for.'),
            textGone: z.string().nullable().describe('Text to wait to disappear.'),
            time: z.number().nullable().describe('Time to wait in seconds.'),
        }),
        execute: async (args) => {
            const payload = {
    ...
    tool({
        ...
        parameters: z.object({
            url: z.string().nullable().describe('The URL to open in the new tab.'),
        }),
        execute: async (args) => {
    ...
    tool({
        ...
        parameters: z.object({
            index: z.number().nullable().describe('The index of the tab to close.'),
        }),
        execute: async (args) => {
